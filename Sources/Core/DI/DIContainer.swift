...
final class DIContainer: ObservableObject {
    ...
    init() {
        ...
        self.persistenceService = PersistenceService(logger: logger)
        self.authenticationService = AuthenticationService(logger: logger)
        self.appMonitorService = AppMonitorService(
            logger: logger,
